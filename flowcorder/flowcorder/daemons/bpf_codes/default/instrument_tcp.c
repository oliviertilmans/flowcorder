...
int kprobe__tcp_validate_incoming(struct pt_regs *ctx, struct sock *sk,
		struct sk_buff *skb, const struct tcphdr *th, int syn_inerr)
{
...
#ifndef __HAS_MPTCP
int kretprobe__tcp_validate_incoming(struct pt_regs *ctx)
{
